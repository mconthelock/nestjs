...
export class InquiryService {
    ...
    async search(searchDto: searchInqDto) {
        ...
        if (searchDto.IS_DETAILS) {
            ...
            .leftJoinAndMapMany('inq.orders', Orderpart, 'orders', 'inq.INQ_NO = orders.INQUIRY_NO AND details.INQD_DRAWING = orders.DWGNO_MELTEC AND orders.REVISION_CODE != :rev', { rev: 'D' })

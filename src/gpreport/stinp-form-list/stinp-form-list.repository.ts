...
import { CreateStinpFormListDto, PrimaryKeyStinpFormListDto } from './dto/create-stinp-form-list.dto';
...
export class StinpFormListRepository extends BaseRepository {
    ...
    async update(condition: PrimaryKeyStinpFormListDto, data: UpdateStinpFormListDto) {

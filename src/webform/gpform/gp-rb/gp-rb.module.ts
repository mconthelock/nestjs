...
import { GpRbController, ShowCusStampGpRbController, ShowstampGpRbController } from './gp-rb.controller';
...
@Module({
  imports:[TypeOrmModule.forFeature([RB_STAMP_REQ],'webformConnection')],
...
@Module({
  imports:[TypeOrmModule.forFeature([RB_CUS_STAMP_REQ],'webformConnection')], 
